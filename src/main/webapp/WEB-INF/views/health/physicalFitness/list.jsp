...
<nav class="w-breadcrumb">
    ...
    <span class="c-gray en">&gt;</span>   体检管理
    <span class="c-gray en">&gt;</span> 学生体能测试管理
...
<div class="pd-20">
    <div class="cl pd-5 bg-1 bk-gray">
        <div class="j_hform">
            ...
            <p>
                ...
                <shiro:hasAnyPermissions name="physicalExam:add">
                <span>
    ...
    <div class="tbl_header mt-20">
        <strong>学生体能测试列表</strong><p class="tbl_header_r">
...
<script>
    $(function () {
        ...
        var dtList = function () {
            ...
            var options = {
                ...
                loadURL: "${ctx}/physicalFitness/getData",
                check: false,
                columns: columns,
                gridContainer: 'table',
        ...
        function bindEvent() {
            ...
            $('#add_role').on('click', function () { //查询
               layer_show("学生体能测试添加","${ctx}/physicalFitness/add")
            });
        }
        function pageInit() {
            bindEvent();
    ...
    function read(id) {
        var url = "${ctx}/physicalFitness/read?id="+id;
        layer_show("学生体能测试查看",url)
    }
    
    function editRow(id) {
        var url = "${ctx}/physicalFitness/add?id="+id;
        layer_show("学生体能测试修改",url)
    }
    ...
    function deleteRow(id) {
        layer.confirm('确认删除吗？', {
            ...
            $.ajax({
                url: "${ctx}/physicalFitness/delete",
                data:{"id":id} ,
