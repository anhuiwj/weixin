...
<nav class="w-breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 体检报告管理
...
<div class="pd-20">
    ...
    <div class="tbl_header mt-20">
        <strong>体检报告列表</strong><p class="tbl_header_r">
...
<script>
    $(function () {
        ...
        var dtList = function () {
            ...
            var options = {
                ...
                loadURL: "${ctx}/physicalExam/getData",
                check: false,
                columns: columns,
                gridContainer: 'table',
        ...
        function bindEvent() {
            ...
            $('#add_role').on('click', function () { //查询
               layer_show("体检添加","${ctx}/physicalExam/add")
            });
        }
        function pageInit() {
            bindEvent();
    ...
    function read(id) {
        var url = "${ctx}/physicalExam/read?id="+id;
        layer_show("体检查看",url)
    }
    
    function editRow(id) {
        var url = "${ctx}/physicalExam/add?id="+id;
        layer_show("体检修改",url)
    }
