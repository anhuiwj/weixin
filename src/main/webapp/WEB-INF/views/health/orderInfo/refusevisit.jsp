...
<body>
<form action="${ctx}/orderInfo/refusevisit" method="post" class="form form-horizontal va-m" id="form-role-edit">
    <input class="input-text" name="id" id="id" value="${id}" style="width:120px;display:none">

    <div style="margin-left: 78px;margin-top: 16px;">
        <div class="f-l w-980 mb-20">
            <label class="f-l mr-30 w-200">拒绝理由</label>
            <textarea class="input-text" name="refuseMsg" datatype="*" style="width:300px;"></textarea>
        </div>
    </div>
