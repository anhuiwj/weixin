...
<nav class="w-breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 到访管理
...
<script>
        ...
        var dtList = function () {
            var columns = [
                ...
                {id: 'id', title: '操作', type: 'string', columnClass: 'text-c',
                    ...
                    var content = '';
                        <shiro:hasAnyPermissions name="arriveOnVisit:read">
                        ...
                        <%--</shiro:hasAnyPermissions>--%>
                        <shiro:hasAnyPermissions name="arriveOnVisit:delete">
            ...
            var options = {
                ...
                loadURL: "${ctx}/arriveOnVisit/getData",
                check: false,
                columns: columns,
                gridContainer: 'table',
    ...
    function read(id) {
        var url = "${ctx}/arriveOnVisit/detail?id="+id;
        layer_show("到访详情",url)
    }
