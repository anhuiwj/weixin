...
<nav class="w-breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 班级查询
...
<script>
    ...
    $(function () {
        ...
        var dtList = function () {
            ...
            var options = {
                ...
                if (arguments[5] != 13) {
                    lodingId = rowData.id;
                    historyList('${ctx}/classInfo/getData2',lodingId);
                }
            }
            };
        ...
        function bindEvent() {
            ...
            $('#add_role').on('click', function () { //查询
               layer_show("班级新增","${ctx}/classInfo/add")
            });
        }
        function pageInit() {
            bindEvent();
    ...
    function addUser(id) {
        layer_show("添加","${ctx}/classInfo/addUser?classId="+id)
    }
            ...
            var columns = [
                ...
                },
                {
                    ...
                    resolution: function (value, record) {
                        ...
                        var content = '<a class="btn btn-primary size-MINI radius" onclick="removeUser(\''+record.id+'\');" >删除</a>';
                        return content;
                    }
                },
