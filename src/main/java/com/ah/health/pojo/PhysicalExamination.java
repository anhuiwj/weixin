...
public class PhysicalExamination {
    ...
    public String getColorVisionLeft() {
        return colorVisionLeft;
    }

    public void setColorVisionLeft(String colorVisionLeft) {
        this.colorVisionLeft = colorVisionLeft == null ? null : colorVisionLeft.trim();
    }

    public String getColorVisionRight() {
        return colorVisionRight;
    }

    public void setColorVisionRight(String colorVisionRight) {
        this.colorVisionRight = colorVisionRight == null ? null : colorVisionRight.trim();
    }
