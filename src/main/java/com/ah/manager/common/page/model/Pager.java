...
import com.ah.manager.common.page.PageQuery;

import java.util.List;
import java.util.Map;

public class Pager implements PageQuery {
	 ...
	 * 显示数据集
	 */
	private List<? extends  Object> exhibitDatas;
	...
	public List<? extends Object> getExhibitDatas() {
		return exhibitDatas;
	}

	public void setExhibitDatas(List<? extends Object> exhibitDatas) {
